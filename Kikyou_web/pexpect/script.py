...
这里有一个问题，假如执行vim编辑文件，script.log里面的记录全是乱码
"""
...
def main():
    ...
    'print like these: time.struct_time(tm_year=2015, tm_mon=1, tm_mday=9, tm_hour=18, tm_min=55, tm_sec=15, tm_wday=4, tm_yday=9, tm_isdst=0)'
    print time.localtime()[:-3]
    'print like these: (2015, 1, 9, 18, 54, 8)'
