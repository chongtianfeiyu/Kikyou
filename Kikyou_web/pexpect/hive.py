...
#             port=22
        ...
        {'192.168.100.245': ('192.168.100.245', 'root', 'dawx@99', None), '192.168.100.246': ('192.168.100.246', 'root', 'dawx@99', None)}
        '''
...
def main ():
    '''
        参数option为字典，如：{'sameuser': True, 'verbose': False, 'samepass': True}
        参数args为列表，如：['192.168.100.246', '192.168.100.245']
    '''
    ...
    ['192.168.100.246', '192.168.100.245']
    {'192.168.100.245': None, '192.168.100.246': None}
    '''
...
if __name__ == '__main__':
    try:
        ...
        print options
        #{'sameuser': True, 'verbose': False, 'samepass': True}
        print args
        #['192.168.100.246', '192.168.100.245']
